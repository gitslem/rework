              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-gray-600 mt-1">Communicate with your agents</p>
                  </div>
                  {unreadCount > 0 && (
                            ...
                            <div className="flex justify-between items-start mb-2">
                              <div className="flex-1">
                                <div className="flex items-center gap-2 mb-1">
                                  ...
                                  {message.status === 'unread' && (
                                    <span className="bg-blue-600 text-white text-xs px-2 py-1 rounded-full font-bold">New</span>
                                  )}
                                  {message.status === 'accepted' && (
                                    <span className="bg-green-600 text-white text-xs px-2 py-1 rounded-full font-bold">Accepted</span>
                                  )}
                                  {message.saved && (
                              ...
                              <div className="flex items-center gap-2">
                                <button
                                  ...
                                  className={`p-2 rounded-lg transition-colors ${message.saved ? 'text-yellow-500 hover:bg-yellow-50' : 'text-gray-400 hover:bg-gray-100'}`}
                                >
