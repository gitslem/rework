...
from app.api.endpoints import auth, projects, applications, users, ai_briefs, sandboxes, proof_of_build, collaboration, payments, escrow, reviews, ai_copilot, freelancers, milestones, webhooks
...
app.include_router(webhooks.router, prefix=settings.API_V1_STR, tags=["webhooks-v1"])
app.include_router(webhooks.router, tags=["webhooks"])  # Direct /webhooks/* endpoints
